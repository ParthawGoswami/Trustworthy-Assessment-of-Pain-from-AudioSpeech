...
"""Train a baseline pain model from the TAME Pain dataset.

Outputs:
- `<outdir>/checkpoint.pt` (training artifact)
- `<outdir>/model_bundle.pt` (ready to load in Streamlit demo)
"""
